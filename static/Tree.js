                ...
                if (datar[5] != null) {
                    if (datar[4] == false) {
                        ...
                        if (datar[2] != null) {
                            ...
                            fTree.push({ id: datar[6], mid: datar[5][0], pid: datar[5][1], Name: datar[0], Born: new Date(datar[1]["_Date__year"], datar[1]["_Date__month"], datar[1]["_Date__day"]), Died: new Date((datar[2]["_Date__year"], datar[2]["_Date__month"], datar[2]["_Date__day"])), Place: datar[3], Married: datar[4] });
                        } else {

                            fTree.push({ id: datar[6], mid: datar[5][0], pid: datar[5][1], Name: datar[0], Born: new Date(datar[1]["_Date__year"], datar[1]["_Date__month"], datar[1]["_Date__day"]), Place: datar[3], Married: datar[4] });
                        }
                        ...
                        if (datar[2] != null) {
                            ...
                            fTree.push({ id: datar[7], mid: datar[5][0], pid: datar[5][1], Name: datar[0], Born: new Date(datar[1]["_Date__year"], datar[1]["_Date__month"], datar[1]["_Date__day"]), Died: new Date((datar[2]["_Date__year"], datar[2]["_Date__month"], datar[2]["_Date__day"])), Place: datar[3], Married: datar[4] });
                        } else {

                            fTree.push({ id: datar[7], mid: datar[5][0], pid: datar[5][1], Name: datar[0], Born: new Date(datar[1]["_Date__year"], datar[1]["_Date__month"], datar[1]["_Date__day"]), Place: datar[3], Married: datar[4] });
                        }
                    ...
                    if (datar[4] == false) {
                        ...
                        if (datar[2] != null) {
                            ...
                            fTree.push({ id: datar[7], Name: datar[0], pids: datar[6][0], Born: new Date(datar[1]["_Date__year"], datar[1]["_Date__month"], datar[1]["_Date__day"]), Died: new Date((datar[2]["_Date__year"], datar[2]["_Date__month"], datar[2]["_Date__day"])), Place: datar[3], Married: datar[4] });
                        } else {

                            fTree.push({ id: datar[7], Name: datar[0], pids: datar[6][0], Born: new Date(datar[1]["_Date__year"], datar[1]["_Date__month"], datar[1]["_Date__day"]), Place: datar[3], Married: datar[4] });
                        }
